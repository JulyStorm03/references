...
# 4. Switch statement
$dayOfWeek = "Tuesday" #if the statement within the switch statement matches the value in the variable, then it outputs the statement
...
$JsonData = Get-Content -Path "C:\notes\references\powershell\powershell\Ex_Files_PowerShell_Automating_IT_Administration\ExerciseFiles\Assets\Computer-Assets.json" -Raw -Encoding UTF8 | ConvertFrom-Json
